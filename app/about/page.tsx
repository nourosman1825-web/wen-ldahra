...
export default function AboutPage() {
  return (
    <main className="max-w-6xl mx-auto px-5 sm:px-8 md:px-10 py-6 sm:py-10 md:py-14 flex flex-col min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 py-6 sm:py-8 border-t border-brown/10">
        <div>
          <h4 className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-brown/80 mb-3">
            Quick Links
          </h4>
          <ul className="space-y-2 text-sm text-dark-brown">
            <li><a href="#" className="hover:text-brown transition">About</a></li>
            <li><a href="#" className="hover:text-brown transition">Explore</a></li>
            <li><a href="#" className="hover:text-brown transition">Categories</a></li>
            <li><a href="#" className="hover:text-brown transition">Contact</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-dark-brown">
            <li><a href="#" className="hover:text-brown transition">Blog</a></li>
            <li><a href="#" className="hover:text-brown transition">FAQ</a></li>
            <li><a href="#" className="hover:text-brown transition">Privacy</a></li>
            <li><a href="#" className="hover:text-brown transition">Terms</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4 text-sm text-dark-brown">
            <a href="#" className="hover:text-brown transition">LinkedIn</a>
            <a href="#" className="hover:text-brown transition">Twitter</a>
            <a href="#" className="hover:text-brown transition">Facebook</a>
          </div>
        </div>
      </div>

      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 pt-4 pb-2 border-t border-brown/5 text-xs text-brown/70">
        <span>&copy; 2026 WEN EL DAHRA. All rights reserved.</span>
        <div className="flex gap-3">
          <a href="#" className="hover:text-brown transition">Privacy Policy</a>
          <span>|</span>
          <a href="#" className="hover:text-brown transition">Terms of Service</a>
        </div>
      </div>
    </main>
  );
